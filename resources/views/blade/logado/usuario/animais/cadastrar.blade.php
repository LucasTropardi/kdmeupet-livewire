                        ...
                        <form action="{{ route('animal.cadastrar') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mt-2 grid grid-cols-12 gap-4 content-center dark:bg-gray-800 dark:text-gray-100">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-select name="situacao_id" :options="$situacoes" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm" autofocus/>
                            ...
                            <div class="col-span-12 md:col-span-6">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-text-input name="anNome" id="anNome" class="block mt-1 w-full" type="text" name="anNome" required autocomplete="anNome" />
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-text-input name="anContato" id="anContato" class="block mt-1 w-full" type="text" name="anContato" required autocomplete="anContato" />
