            ...
            <div class="bg-gray-300 shadow sm:rounded-lg p-1.5 dark:bg-gray-600 dark:text-gray-100">
                <div class="bg-blue-300 shadow sm:rounded-lg p-1.5 dark:bg-gray-500 dark:text-gray-100">
                    <div class="p-4 sm:p-8 bg-white sm:rounded-lg dark:bg-gray-800 dark:text-gray-100">
                        <form action="{{ route('adocao.alterar', $adocao->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mt-2 grid grid-cols-12 gap-4 content-center dark:bg-gray-800 dark:text-gray-100">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-select name="especie_id" id="especie_id" :options="$especies" selected="{{ $adocao->situacao_id }}" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm" />
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-select name="raca_id" id="raca_id" :options="$racas" selected="{{ $adocao->raca_id }}" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm" />
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-select name="tamanho_id" id="tamanho_id" :options="$tamanhos" selected="{{ $adocao->tamanho_id }}" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm" />
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-select name="cor_id" id="cor_id" :options="$cores" selected="{{ $adocao->cor_id }}" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm" />
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-text-input name="adNome" id="adNome" value="{{ $adocao->adNome }}" class="block mt-1 w-full" type="text" name="adNome" required autocomplete="adNome" />
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-text-input name="adIdade" id="adIdade" value="{{ $adocao->adIdade }}" class="block mt-1 w-full" type="text" name="adIdade" required autocomplete="adIdade" />
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-text-input name="adContato" id="adContato" value="{{ $adocao->adContato }}" class="block mt-1 w-full" type="text" name="adContato" required autocomplete="adContato" />
                                ...
                                <div class="col-span-12 md:col-span-12">
                                    ...
                                    <x-text-input name="adEndereco" id="adEndereco" value="{{ $adocao->adEndereco }}" class="block mt-1 w-full" type="text" name="adEndereco" required autocomplete="adEndereco" />
                                    <x-input-error :messages="$errors->get('adEndereco')" class="mt-2" />
                                </div>

                                <div class="col-span-12 md:col-span-12">
                                    <x-upload-imagem id="adImagem" inputName="adImagem" class="block mt-2 w-full" />
                                </div>
