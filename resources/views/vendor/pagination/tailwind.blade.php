                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-600 bg-blue-200 border border-blue-300 cursor-default leading-5 dark:text-white dark:bg-gray-500 dark:border-gray-500">{{ $page }}</span>
                                    </span>
                                @else
