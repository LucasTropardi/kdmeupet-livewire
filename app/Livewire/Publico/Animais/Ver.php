...
namespace App\Livewire\Publico\Animais;
...
class Ver extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->user_id = $this->animal->user->id;
    ...
    {
        return view('livewire.publico.animais.ver', [
            'dataCadastrada' => Carbon::parse($this->animal->anData)->format('d/m/Y'),
            'mensagens' => Mensagem::where('animal_id', $this->animal_id)->orderBy('dataMensagem', 'asc')->paginate(3),
        ]);
    }
